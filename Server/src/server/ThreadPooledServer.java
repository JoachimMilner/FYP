...
public class ThreadPooledServer implements ConnectableComponent, Runnable {
	...
	/**
	 * The number of requests that have been received been received by all server processing threads.
	 */
	private int totalRequestsReceived = 0;
	
	/**The number of responses that have been sent by all server processing threads.
	 * 
	 */
	...
	/**
	 * @return The total number of requests that have been received by all server threads.
	 */
	...
	/**
	 * Each {@link RunnableRequestProcessor} instance calls this method whenever they receive a client request.
	...
	/**
	 * @return The total number of responses that have been sent by all server threads.
	 */
	...
	/**
	 * Each {@link RunnableRequestProcessor} instance calls this method whenever they send a response to a client.
	 * Synchronized for thread safety.
	 */
